...
class OrderController extends Controller {
	...
	function bulkdelete( Request $request ) {
		...
		return redirect()->route( 'order.index' )->with( 'added', 'Selected Orders Deleted Successfully !' );
	...
	public
	function QuickOrderDetails( Request $request ) {
	...
	public
	function printInvoice( $orderID, $id ) {
	...
	function store( Request $request ) {
		...
		$data->save();
		return back()->with( 'updated', 'Order has been updated' );
	}
	...
	function update( Request $request, $id ) {
		...
		if ( $request->order_status == "pending" ) {
			...
			/*Sending to user*/
			User::find( $order->user_id )->notify( new SendOrderStatus( $order ) );
			/*END*/
		}
	...
	function destroy( $id ) {
		...
		session()->flash( "deleted", "Order Has Been deleted" );
