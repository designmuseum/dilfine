...
class MainController extends Controller
{
    ...
    public function details_product($id)
    {
        ...
        if (isset($pro)) {
            ...
            SEOTools::setDescription(strip_tags($pro->des));
            SEOMeta::addKeyword([$pro->tags]);
            
            
            SEOTools::opengraph()->addProperty('type', 'webpage');
            SEOTools::twitter()->setSite(url('/'));
            SEOTools::jsonLd()->addImage(url('variantimages/thumbnails/'.$pro->subvariants[0]->variantimages['main_image']));
            OpenGraph::addImage(url('variantimages/thumbnails/'.$pro->subvariants[0]->variantimages['main_image']));
