		...
		<div class="box-body">
			<div class="callout callout-success">
				...
				<ul>
					...
					<li>For Prepaid cancelled orders with refund method choosen Bank You can update order IF refund is complete.</li>
					<li>For Prepaid cancelled orders with refund method choosen orignal you can track refund status LIVE from respective Payment gateway & Update TXN/REF ID.
					</li>
				</ul>
			</div>
			...
			<div class="nav-tabs-custom">
				...
				<ul class="nav nav-tabs" id="ordertabs" role="tablist">
				    <li data-toggle="popover" data-trigger="focus" title="Single cancelled Orders" data-content="If order have only 1 item than its count in single cancelled orders." role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Single cancelled Orders  @if($partialcount>0)<span class="badge badge-danger"><span id="pcount">{{ $partialcount }}</span> New @endif</a></li>
				    <li data-toggle="popover" data-trigger="focus" title="Bulk cancelled Orders" data-content="If order have more than 1 item than its count in Bulk cancelled orders." role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Bulk cancelled Orders @if($fullcount>0)<span class="badge badge-danger"><span id="fcount">{{ $fullcount }}</span> New @endif</a></li>
				</ul>
