                    ...
                    <div role="tabpanel" class="tab-pane" id="profile">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-border">
                                    <b>Ex. </b>If you enter +10 and product price is 100 then price will be 110
                                    <br> OR <br>
                                    If you enter -10 and product price is 100 then price will be 90
                                </p>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input data-placement="bottom" id="stock" data-toggle="popover" data-trigger="focus"
                                    ...
                                    data-content="It will add stock in existing stock. For example you enter 10 and existing stock is 20 then total stock will be 30."
