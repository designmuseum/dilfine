...
<head>
  ...
  <script>
    ...
    if (isIE || isFirefox) {
      ...
      pageStylesheet.href = "{{ url('admin/css/style.css') }}";
...
<body class="hold-transition fixed skin-blue sidebar-mini pace-done">
                ...
                <li>
                  ...
                  <ul class="menu">
                    ...
                    <li>
                      ...
                      <a onclick="markread('{{ $notification->id }}')"
                        href="{{ url('admin/users/'.$notification->url.'/edit') }}">
  ...
  @notify_js
  @notify_render
  <script>toastr.options.closeMethod = 'fadeOut';
...
toastr.options.closeEasing = 'swing';
  ...
  <!-- SlimScroll -->
  <script async src="{{url('admin/vendor/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
  <!-- FastClick -->
