...
@section("body")
	<div class="box">
		...
		<div class="box-body">
			 <a href="{{ url('files/ProductCSV.xlsx') }}" class="btn btn-md btn-success"> Download Example For xls File</a>
			 <hr>
            ...
            <div class="row">
            	<div class="form-group col-md-6">
            	 <label for="file">Choose your xls File :</label>
             	 <input required="" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" type="file" name="file" class="form-control">
             	 @if ($errors->has('file'))
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><p>Enter if your product has warranty else enter <b>None</b>.</p>
						   <p><b>(eg. 1)</b></p>
						</td>
					</tr>
					...
					<tr>
						<td>22</td>
						<td><b>Warranty in (months, years, days)</b> (Optional)</td>
						<td><p>Enable if your product has warranty else enter <b>None</b>.</p>
						   <p><b>(Available format: days, years, months)</b></p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable if your product has warranty else enter <b>None</b>.</p>
						   <p><b>(Available types: Guarantee, Warranty)</b></p>
						</td>
					</tr>
					...
					<tr>
						...
						<td>Enter product tags by putting comma to separate tags.</td>
					</tr>
