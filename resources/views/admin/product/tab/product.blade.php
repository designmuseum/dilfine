<br>
   <form action="{{url('admin/products/')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="margin-top-15 col-md-6">
                      ...
                      <div class="margin-top-15 col-md-6">
                         ...
                         <label>
                          ...
                          <br>
                          <small class="text-muted"><i class="fa fa-question-circle"></i> Don't put comma while entering PRICE</small>
                      </div>
                      ...
                      <div class="margin-top-15 col-md-6">
                        ...
                        <label>
                          ...
                          <br>
                          <small class="text-muted"><i class="fa fa-question-circle"></i> Don't put comma while entering OFFER price</small>
                      </div>
                    ...
                    <div class="margin-top-15 col-md-4">
                       ...
                       <small class="txt-desc">(If Enabled Then Free Shipping will be enabled for this product) </small>
