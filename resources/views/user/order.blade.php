                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                        ...
                        @foreach($firstarray as $o)
                          ...
                          @php
                                $orivar = App\AddSubVariant::withTrashed()->find($o->variant_id);
					            if(empty($orivar->main_attr_value)){
<!--					             echo $o->variant_id;die;-->
					             continue;
					            }
                  ...
                  <div class="panel-footer">
                    ...
                    <span>
                      <p>
                        <b>{{ __('Total') }} :</b> 
                        <i class="{{ $order->paid_in }}"></i>{{ number_format((float)$order->order_total , 2, '.', '')}}
                      </p>
                      <p>
