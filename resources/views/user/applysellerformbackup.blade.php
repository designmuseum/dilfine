...
@endphp
@section('title','Apply For Seller Account |') 
@section("body")
      ...
      <div class="bg-white2">
        ...
        <div class="wizard-container">
          ...
          <div class="wizard-card" data-color="orange" id="wizardProfile">
            <form method="post" enctype="multipart/form-data" action="{{route('apply.seller.store')}}">
              {{csrf_field()}}
                ...
                <ul class="nav nav-tabs" id="myTabs" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#about" role="tab"
                      aria-controls="about" aria-selected="true"><i class="fa fa-clone" aria-hidden="true"></i>
                      {{ __('staticwords.Agreement') }}</a>
                  </li>

                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#about" role="tab" aria-controls="about"
                      aria-selected="true"><i class="fa fa-user-o" aria-hidden="true"></i>
                      {{ __('staticwords.sellerinfo') }}</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="ac" data-toggle="tab" href="#account" role="tab" aria-controls="account"
                      aria-selected="false">{{ __('staticwords.PaymentDetails') }}</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#cat" role="tab"
                      aria-controls="contact" aria-selected="false">{{ __('staticwords.SellerInterview') }}</a>
                  </li>
                </ul>
              ...
              <div class="tab-content">
                <div class="tab-pane show fade active" id="agreement">

                  @php
                  $sellerterm = App\TermsSettings::firstWhere('key','seller-register-term');
                  @endphp
                  <br>
                  <h2>{{ $sellerterm['title'] }}</h2>
                  <hr>
                  ...
                  <div class="form-group">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="eula">
                        <b>{{ __('I Agree to terms and conditions') }}</b>
                      </label>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="first-name" placeholder="{{ __('staticwords.PleaseEnterStoreAddress') }}"
                          ...
                          class="required">{{$errors->first('address')}}</span> </div>
                      <div class="gap form-group">
                        <label class="font-weight-bold">{{ __('staticwords.MobileNo') }} <small
                            class="required">*</small></label>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="gap form-group" id="paypal_email">
                        ...
                        <input type="email" name="paypal_email" placeholder="Please Enter Paypal Email"
                          ...
                          class="required">{{$errors->first('paypal_email')}}</span> 
                        </div>
                      <div class="gap form-group" id="paytem_mobile">

                        <label class="font-weight-bold">{{ __('Paytm Mobile Number') }}: <small
                            class="required">*</small></label>
                        <input pattern="[0-9]+" title="Invalid Paytm No." type="text" name="paytem_mobile"
                          placeholder="Please Enter Paytm Kyc Completed Mobile Number" value="{{old('paytem_mobile')}}"
                      ...
                      <div class="row">
                        <div class="col-md-2 col-xs-4">
                          <div class="custom-control custom-radio">
                            <input required="" type="radio" id="yes" value="Yes" name="name1"
                        ...
                        <div class="m-55 col-md-2 col-xs-4">
                          <div class="custom-control custom-radio">
                            <input required="" type="radio" id="No" value="No" name="name1"
                              class="custom-control-input">
