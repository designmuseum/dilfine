        ...
        <div class="col-md-12 col-xl-3">
            <div class="bg-white" style='margin-top: 10px;'>
              <div align="center">
                ...
                @endif
                <div class="user_header"><h5 class="user_m">{{$user->name}}</h5></div>
                  <h5>{{ $user->email }}</h5>
...
<!-- =========================small screen navigation end ============================ -->      
      ...
      <small class="txt-desc">({{ __('staticwords.PleaseEnterUserName') }})</small>
        ...
        <select disabled name="country_id" class="form-control col-md-12 col-xs-12" id="country_id">
        ...
        {{ __('staticwords.State') }}: <span class="required">*</span>
         ...
         <select disabled name="state_id" class="form-control col-md-12 col-xs-12" id="upload_id" >
          <option>{{ __('staticwords.PleaseChoose') }}</option>
           @foreach($states as $c)
        ...
        <select disabled name="city_id" id="city_id" class="form-control col-md-12 col-xs-12">
          <option>{{ __('staticwords.PleaseChoose') }}</option>
           @foreach($citys as $c)
        ...
        <form id="form1" action="{{ route('pass.update',$user->id) }}" method="POST">
          ...
          <div class="form-group eyeCy">
               ...
               <label class="font-weight-bold" for="password">{{ __('staticwords.EnterPassword') }}:</label>
                <input minlength="8" required="" id="password"  type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Enter password" name="password" />
