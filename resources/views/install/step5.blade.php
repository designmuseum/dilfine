  ...
  <div class="form-row">
        ...
        <div class="col-md-4 mb-3">
          <label for="email">{{ __('Contact Email') }}:</label>
             <input name="email" type="email" class="form-control" id="email" placeholder="user@example.com" value="{{ old('email') }}" required>
        ...
        <div class="col-md-6 mb-3">
          <label for="pincode">{{ __('Pincode') }}:</label>
             <input title="Enter valid pincode" pattern="[0-9]+" name="pincode" type="text" class="form-control" id="pincode" placeholder="Pin Code" value="{{ old('pincode') }}" required>
