...
<html lang="en">
  ...
  <div class="form-row">
        ...
        <div class="col-md-6 mb-3">
             ...
             <input name="DB_DATABASE" type="text" class="form-control" id="DB_DATABASE" placeholder="Database Name" value="{{ env('DB_DATABASE') != '' ? env('DB_DATABASE') : old('DB_DATABASE') }}" required>
        ...
        <div class="col-md-6 mb-3">
             ...
             <input name="DB_USERNAME" type="text" class="form-control" id="DB_USERNAME" placeholder="Database User Name" value="{{ env('DB_USERNAME') !='' ? env('DB_USERNAME') : old('DB_USERNAME') }}" required>
