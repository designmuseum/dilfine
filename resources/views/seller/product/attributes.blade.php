							...
							<td>
								...
								@foreach($pat->cats_id as $cats)
								 @php 
								    ...
								    $getcatname = !empty($getcatname->title)?$getcatname->title:"";
								    if(!empty($getcatname)){$printCat .= !empty($printCat)?",".$getcatname:$getcatname;}
								 @endphp
								@endforeach
								@php 
								$printCat = !empty($printCat)?$printCat:"Not linked to any active category";
								@endphp
								{{$printCat}}
							</td>
