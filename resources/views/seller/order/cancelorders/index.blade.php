		...
		<div class="box-body">
			<div class="callout callout-success">
				...
				<ul>
					...
					<li>For Prepaid cancelled orders with refund method choosen Bank You can View Details IF refund is complete.</li>
			...
			<div class="nav-tabs-custom">
				 <ul class="nav nav-tabs" id="myTab" role="tablist">
    					...
    					<li data-toggle="popover" data-trigger="focus" title="Bulk cancelled Orders" data-content="If order have more than 1 item than its count in Bulk cancelled orders." role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Bulk cancelled Orders @if($partialcount2>0)<span class="badge badge-danger"><span id="fcount">{{ $partialcount2 }}</span> New @endif</a></li>
				 </ul>
			</div>
