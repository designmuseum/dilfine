      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="nav-item">
          <div class="quant-input">
            <input type="number" value="1" max="99" class="qty-section">
          </div>
        </li>
...
<div class="body-content outer-top-xs outer-top-xs-one detail-page-block">
  <div class='container-fluid'>
    <div class='row no-gutters single-product'>
     <div class='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-2 sidebar left-sidebar d-none'>
...
<!-- ============================================== Testimonials: END ============================================== -->
          ...
          <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12  col-xl-12 rht-col main-content'>
              ...
              <div class="stock-container info-container">
                ...
                <?php
                  ...
                  <div class="pull-left">
                   ...
                   <i class="color147ED2 fas fa-star" aria-hidden="true"></i> {{ __('staticwords.ratetext') }}
                  </div>
                  <br>
                  <p></p>
                  @endif
                        ...
                        <table border="0" class="width100">
                          ...
                          @endphp
                            <tr>
                              ...
                              <td width="20%" class="{{$cvar->attribute->attr_name}}">
                                @if($cvar->attribute->attr_name == "Color" || $cvar->attribute->attr_name == "color" || $cvar->attribute->attr_name == "Colour" || $cvar->attribute->attr_name == "colour"||stripos('colour',$cvar->attribute->attr_name)!==false)
                       ...
                       <div class="product-image">
                        ...
                        <div class="product-info text-left">
                          ...
                          $show_price = $show_price*$conversion_rate;
                            ...
                            @if(Session::has('currency'))
                              @if($convert_price == 0 || $convert_price == 'null')
                                <span class="price {{$convert_price_form}}"><i class="{{session()->get('currency')['value']}}"></i>{{round($show_price,2)}}</span>
                              @else
                                <span class="price {{$convert_price_form}}"><i class="{{session()->get('currency')['value']}}"></i>{{round($convert_price,2)}}</span>
