      ...
      <div class="col-xl-8 col-md-12 col-sm-12">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                  ...
                  <!-- panel-body  -->
                    <div class="panel-body">
                      ...
                      @auth
                        <p class="font-size14">
                        <b><i class="text-green far fa-check-circle" aria-hidden="true"></i>
                        {{ Auth::user()->name }}</b> </p>
                        <p class="font-weight500"><i class="text-green far fa-check-circle" aria-hidden="true"></i>
                          {{ Auth::user()->email }}
                        </p>
                      @endauth
                    </div>
        ...
        <div class="form-group">
          <label class="font-weight-bold" for="exampleInputEmail1">{{__('staticwords.City')}} <span class="required">*</span></label>
            <select name="billing_city" required id="billing_city" class="form-control">
                      ...
                      <div class="row">
                        <div class="col-12 col-lg-9">
                          <div class="row no-gutters">
                            <div class="col-12 col-md-1 col-lg-1 col-xl-12">
                              <div class="checkout-page-img">
                                <img class="pro-img img-responsive" src="{{url('variantimages/thumbnails/'.$orivar->variantimages['main_image'])}}" alt="product_image">
                              </div>
                            </div>
                            <div class="col-12 col-md-11 col-lg-11 col-xl-12">
                          ...
                          <p><b>@if($row->product->offer_price != 0)
                                    ...
                                    <small class="text-muted">( <b>{{__('staticwords.TotalPrice')}}</b> )</small>
                                      ...
                                      @endphp
                                            ...
                                            <br>
                                            <small class=" text-justify" style="font-size: 9px" class="help-block">( {{__('staticwords.ptax')}} )</small>
          ...
          <!-- Nav tabs -->
            <div class="nav flex-column nav-pills" aria-orientation="vertical">
              ...
              @if($config->cashfree_enable == '1')
                <a class="nav-link" href="#cashfreeTab" data-toggle="tab">{{ __('staticwords.PayVia') }}  Cashfree</a>
              @endif
          ...
          <div class="tab-content">
            ...
            @if($config->payhere_enable == '1')
                  ...
                  @if($checkoutsetting_check->checkout_currency == 1)
                    <div class="tab-pane" id="payheretab">
                      ...
                      <hr>
                        ...
                        <form method="post" action="https://sandbox.payhere.lk/pay/checkout">
                            ...
                            <button type="submit" class="payhere-buy-now-button">
                              <span> <i class="{{ session()->get('currency')['value'] }}"></i> {{ sprintf("%.2f",Crypt::decrypt($secure_amount),2) }} <img src="{{ url('images/payhere.png') }}" alt="payherelogo" title="Pay with Payhere"></span> 
                            </button>   
                          </form> 
                      ...
                      @else
                        ...
                        <h4>{{ __('Payhere') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
                  ...
                  @else
                    <div class="tab-pane" id="payheretab">
                      ...
                      <hr>
                      <p class="text-muted"><i class="fa fa-lock"></i> {{ __('Your transcation is secured with Payhere transcations.') }}.</p>
                    </div>
                @endif
                  ...
                  @if($checkoutsetting_check->checkout_currency == 1)
                    <div class="tab-pane" id="cashfreeTab">
                      ...
                      <hr>
                        @if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'cashfree'))
                          ...
                          <form action="{{ route('cashfree.pay') }}" method="POST" autocomplete="off">
                            ...
                            <input pattern="[0-9]+" required="" value="{{ Auth::user()->mobile }}" name="phone" type="hidden"/>
                      ...
                      @else
                        ...
                        <h4>{{ __('Cashfree') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
              ...
              @if($checkoutsetting_check->checkout_currency == 1)
                <div class="tab-pane" id="omiseTab">
                  ...
                  @else
                    ...
                    <h4>{{ __('Omise') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
              ...
              @if($checkoutsetting_check->checkout_currency == 1)
                <div class="tab-pane" id="raveTab">
                  ...
                  @else
                    ...
                    <h4>{{ __('Rave') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
            ...
            @if($config->moli_enable == '1')
              ...
              @if($checkoutsetting_check->checkout_currency == 1)
                <div class="tab-pane" id="mollieTab">
                  ...
                  @else
                    ...
                    <h4>{{ __('Mollie') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
              ...
              @else
                <div class="tab-pane" id="mollieTab">
                  ...
                  <hr>
                  <p class="text-muted"><i class="fa fa-lock"></i> {{ __('Your transcation is secured with Mollie transcations.') }}.</p>
                </div>
              @endif
            ...
            @if($checkoutsetting_check->checkout_currency == 1)
              <div class="tab-pane" id="skrillTab">
                ...
                @else
                  ...
                  <h4>{{ __('Skrill') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
            ...
            @else
              <div class="tab-pane" id="skrillTab">
                ...
                <hr>
                <p class="text-muted"><i class="fa fa-lock"></i> {{ __('Your transcation is secured with Skrill transcations.') }}.</p>
              </div>
            @endif
                ...
                @if($checkoutsetting_check->checkout_currency == 1)
                          <div class="tab-pane" id="codpaytab">
                            @if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'cashOnDelivery'))
                                ...
                                @else
                                  <h4>
                                    <h4>{{ __('COD') }} {{__('staticwords.chknotavbl') }} <b>{{ session()->get('currency')['id'] }}</b>.</h4>
                                  </h4>
                                @endif
                                </div>
                           @else
