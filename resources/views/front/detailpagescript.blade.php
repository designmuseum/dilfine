...
@endphp
     ...
     $('.quant-input').html('<input type="number" id="nmovimentos" name="quantity" value="'+data['min_order_qty']+'" min="'+data['min_order_qty']+'" max="99" maxorders="'+data['max_order_qty']+'">');

      $('.quant-input').html('');
      $('.quant-input').append('<input type="number" value="'+data['min_order_qty']+'" min="'+data['min_order_qty']+'" max="99" maxorders="'+data['max_order_qty']+'" value="1" class="qty-section">');
         ...
         driftzoom();
           ...
           function customDataSuccess(data){
             ...
             $(imgarray).each(function(index){
                ...
                content += "<div class='provarbox' align='center' onclick=\"changeImage('"+url+"/"+imgarray[index]+"')\" ><img alt='productImage' class=\"box-image img-responsive img-fluid\" src=\""+url+"/"+imgarray[index]+ "\"></div>"
           ...
           function customDataSuccess(data){
             ...
             $(imgarray).each(function(index){
               if(imgarray[index] == null){
                ...
                countslide++;
                content += "<div class='provarbox' align='center' onclick=\"changeImage('"+url+"/"+imgarray[index]+"')\"><img alt='productimage' class=\"box-image img-fluid\" src=\""+url+"/"+imgarray[index]+ "\"></div>"
