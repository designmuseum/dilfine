			...
			<div class="row">		
				...
				<div class="col-md-6 col-sm-6 already-registered-login">
					...
					<form novalidate method="POST" class="form register-form outer-top-xs" role="form" action="{{ route('ref.cart.login') }}">
					    ...
					    <input required type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1"  name="email" placeholder="{{ __('Enter Email') }}" value="{{ old('email') }}">
					    @if ($errors->has('email'))
