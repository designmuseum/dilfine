<!DOCTYPE html>
<?php 
//print_r(Session::get('currency'));die;
?>
...
<head>
  ...
  <!-- Default CSS -->
  <link rel="stylesheet" href="{{url('front/css/main.min.css')}}?time=<?=time()?>">
  ...
  <link rel="stylesheet" href="{{ url('css/custom_cn.css') }}?time=<?=time()?>" compile>
  ...
  <link rel="stylesheet" href="{{ url('css/dilfine.css') }}" compile>
  <script>
    var baseUrl = "<?= url('/') ?>";
  </script>
...
<body class="cnt-home">
  ...
  <header class="header-style-1">
    ...
    <div class="top-bar animate-dropdown top-main-block-one">
      <div class="container-fluid">
        ...
        <div class="header-sub-element hidden-xs hidden-sm">
              <div class="sub-left">
                  <img src="{{ url('images/cn-icons/icon-call.png') }}" alt="Customer Care" >
              </div>
              <div class="sub-right">
                  <span>Call Us Free</span>
                  <div class="phone">
                    <a href="tel:7894561230" tiltle="Mobile No.">+91 7894561230</a>
                  </div>
              </div>
          </div>
          <div class="cnt-account">
            <div class="display-none-block">
              <ul class="list-unstyled">
                    ...
                    <ul class="menu notification-menu">
                      ...
                      <li class="notiheaderlightgrey hey1" id="{{ $notification->id }}"
                        ...
                        <a class="font-weight600 color111" @if($notification->n_type == "order")
                          ...
                          <small class="cn-timestamp"><i class="fa fa-clock-o" aria-hidden="true"></i>
                ...
                if($var->variant&&$var->variant->products){
                ...
                @endif
                @if(config('dilfine.comparison_enabled'))
                      ...
                      <div class="modal-body">
                        ...
                        <form action="{{ route('send.feedback') }}" method="POST">
                          ...
                          <div class="form-group">
                            <label class="font-weight-bold" for="">{{ __('staticwords.Name') }}: </label>
                            <input required="" type="text" name="name" class="form-control" value="{{ $auth->name }}">
                          </div>
                          <div class="form-group">
                            <label class="font-weight-bold" for="">{{ __('staticwords.Email') }}: </label>
                            <input required="" type="email" name="email" class="form-control"
                              value="{{ $auth->email }}">
                          </div>
                          <div class="form-group">
                            <label class="font-weight-bold" for="">{{ __('staticwords.Message') }}:</label>
                          ...
                          <div class="rat">
                            <label class="font-weight-bold">&nbsp;{{ __('staticwords.RateUs') }}:</label>
						...
						<small>Note :- All fields are mandatory</small>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="cnt-block d-none">
            <ul class="list-unstyled list-inline">
              ...
              <select name="currency" readonly onchange="val()" id="currency">
              ...
              <select name="currency" onchange="val()" disabled id="currency">
              ...
              <select class="changed_language" name="" disabled id="changed_lng">
                ...
                <div class="control-group search-cat-box">
                  ...
                  <input required="" class="search-field" value="" placeholder="{{ __('staticwords.search') }}"
                    ...
                    <!-- <span class="input-group-btn">
					 ...
					 <input type="hidden" id="searchDropMenu" name="cat" />
                    <div class="dropdownMenu">
                      <button id="dropdownMenuSearchButton" class="dropdownMenuSearch btn" onClick="$('.catDrop').toggleClass('d-none')" type="button"><span id="catSelectedName">All Categories</span> <i class="fas fa-caret-down"></i></button>
                      <ul class="catDrop d-none">
						  <li class="selected"><a onClick="$('#catSelectedName').html($(this).text());$('#searchDropMenu').val('');$('.catDrop .selected').removeClass('selected');$(this).parent('li').addClass('seleted');$('.catDrop').toggleClass('d-none')"><i class="fas fa-caret-right"></i> All Categories</a></li>
                        @foreach(App\Category::orderBy('id','desc')->where('status','1')->get(); as $cat)
                          <li>
                              <a onClick="$('#catSelectedName').html($(this).text());$('#searchDropMenu').val('{{$cat->id}}');$('.catDrop .selected').removeClass('selected');$(this).parent('li').addClass('seleted');$('.catDrop').toggleClass('d-none')"><i class="fas fa-caret-right"></i> {{$cat->title}}</a>
                          </li>
                        @endforeach
                      </ul>
                    </div>
                  ...
                  <div class="basket" >
                    ...
                    <span class="lbl cn-lbl">
                        <div class="basket-item-count">
                          ...
                          <img src="{{ url('images/cn-icons/icon-cart.png') }}" alt="Cart" >
                      </span>
                      <?php
                          $total = 0;
                ...
                for($i = 0; $i<$var_name_count; $i++){ $var_id=$orivar['main_attr_id'][$i];
                  ...
                  <div class="cart-row">
                    <div class="row no-gutters">
                      <div class="col-3 col-xs-3 col-sm-3 col-md-3">
                        ...
                        <a href="{{ url($url) }}" title="{{$row->product->name}}">
                  ...
                  for($i = 0; $i<$var_name_count; $i++){ $var_id=$orivar['main_attr_id'][$i];
                    ...
                    <div class="clearfix cart-total cart-checkout">
                      <div class="d-flex"> <span class="text">{{ __('staticwords.Subtotal') }} :</span><span
                          class='price'>
                          @php
					...
					<div class="cn-flex">
					 @if(!empty($oot) && in_array(0, $oot) || $c<1) <button disabled="disabled" type="button"
                        class="btn btn-upper btn-primary btn-block m-t-20 cn-one">
                        Checkout</button>
                        @else
                        <form action="{{url('checkout')}}" method="post" class="cart-checkout">
                          ...
                          <button type="submit"
                            class="btn btn-upper btn-primary btn-block m-t-20 cn-one">Checkout</button>
                        </form>
                        @endif

                        @if(!empty($oot) && in_array(0, $oot) || $c!=0)
                        <a href="{{url('cart')}}" class="btn btn-upper btn-primary btn-block m-t-20 cn-one"
                    ...
                    <form action="{{ route('s.cart',$token) }}" method="POST" class="cart-checkout cn-two">
                      @csrf
                      <button type="submit"
    ...
    <!-- ============================================== NAVBAR ============================================== -->
    <div class="header-nav animate-dropdown header-nav-screen d-none">
                      ...
                      <div class="side-menu animate-dropdown outer-bottom-xs">
                        ...
                        <nav class="megamenu-horizontal">
                          ...
                          <ul class="nav" id="accordian">
                            ...
                            <li class="dropdown menu-item" id="dropdown" parent="#accordian">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="cn-wrapper">
		  <div class="col-md-12">
		  <div class="cn-footer-blocks">  
		  <div class="cn-footer-block-info">	  
          <div class="cn-logo cn-footer-blocks">
            <img src="{{ url('images/genral/mainlogo.png') }}" alt="dilfine" >
          </div>
              ...
              @if(!empty($genrals_settings->mobile))
                <li class="media">
                  ...
                  <div class="media-body">
					<h4>Write To Us</h4>  
					<a href="mailto:{{$genrals_settings->email}}"
                        tiltle="E-Mail">{{$genrals_settings->email}}
					</a>  
                  </div>
                </li>
                @endif
...
<!--CN CATEGORIES -->			  
          <div class="cn-categories d-none">
            <h3>Categories</h3>
            <ul class="catDrop">
              @foreach(App\Category::orderBy('id','desc')->where('status','1')->get(); as $cat)
                <li>
                    <a onClick="categoryfilter('{{$cat->id}}','','','1','10000000')">{{$cat->title}}</a>
                </li>
              @endforeach
            </ul>
          </div>
    ...
    <div class="copyright-bar header-nav-screen">
      <div class="container">
          <div class="cn-wrap">
			<div class="cn-menu">
                <h3 class="d-none">{{ $footer3_widget->footer2 }}</h3>
              <!-- /.module-heading -->

              <div class="module-body module-small-screen">
                <ul class='list-unstyled'>
				  <li class="last"><a href="{{url('show/about-us')}}" title="Return Policy">About us</a></li>	
				  <li class="last"><a href="{{url('show/privacy-policy')}}" title="Privacy Policy">Privacy Policy</a></li>
                  <li class="last"><a href="{{url('show/terms-condition')}}" title="Terms Policy">Terms and Condition</a></li>
                  <li class="last"><a href="{{url('show/sell-on-dilfine')}}" title="Sell With Us">Sell on Dilfine</a></li>
                  <li class="last"><a href="{{url('show/return')}}" title="Return Policy">Return Policies</a></li>	
<!--
                  <li class="last"><a href="http://classified.dilfine.com/web" title="Classifieds">Classifieds</a></li>	
                  <li class="last"><a href="https://jobs.dilfine.com/" title="Jobs">Jobs</a></li>	
-->
                  <li class="last"><a href="https://modeling.dilfine.com/ " title="Modeling">Modeling</a></li>	
                  <li class="last"><a href="{{url('show/careers')}}" title="Career">Career</a></li>	
                  @if(Auth::check())
            ...
            <p class="cn-copyright">© 2020 Dilfine. All rights reserved.</p>
            <div class="cn-cards">
              <img src="{{ url('images/cn-icons/visa.png') }}" alt="visa" >
              <img src="{{ url('images/cn-icons/mastercard.png') }}" alt="mastercard" >
              <img src="{{ url('images/cn-icons/american-express.png') }}" alt="american-express" >
              <img src="{{ url('images/cn-icons/paypal.png') }}" alt="Paypal" >
              <img src="{{ url('images/cn-icons/razorpay.png') }}" alt="Razorpay" >
            </div>
          </div>
      </div>
    </div>
            ...
            <ul>
              ...
              <li class="m-1">
                <a title="Payhere" target="__blank" href="https://www.payhere.lk/"><img
                    src="{{ url('images/payhere.png') }}" alt="Payhere" class="img-fluid"></a>
              </li>
              @endif

              @if($Api_settings->omise_enable == '1')
              <li class="m-1">
                <a title="Omise" target="__blank" href="https://www.omise.co"><img src="{{ url('images/omise.png') }}"
                    alt="omise" class="img-fluid"></a>
              </li>
              @endif
              ...
              <li class="m-1">
                <a title="Cashfree" target="__blank" href="https://www.cashfree.com/"><img
                    src="{{ url('images/cashfree.png') }}" alt="cashfree" class="img-fluid"></a>
              </li>
              @endif
              ...
              <li class="m-1">
                <a title="mollie" target="__blank" href="https://www.mollie.com/en"><img
                    src="{{ url('images/mollie.png') }}" alt="mollie" class="img-fluid"></a>
              </li>
              @endif
              ...
              <li class="m-1">
                <a title="Rave" target="__blank" href="https://dashboard.flutterwave.com/"><img
                    src="{{ url('images/rave.png') }}" alt="rave" class="img-fluid"></a>
              </li>
              @endif
              ...
              <li class="m-1">
                <a title="Skrill" target="__blank" href="https://www.skrill.com/"><img
                    src="{{ url('images/skrill.png') }}" alt="skrill" class="img-fluid"></a>
              </li>
              @endif
  ...
  <!-- Owlcarousel JS -->
  <script src="{{url('front/vendor/js/owl.carousel.js')}}"></script>
  <!-- Echo JS -->
  ...
  <script>
	...
	$('body').click(function(){
	   !$('.catDrop').attr('class').indexOf('d-none')!=-1?$('.catDrop').addClass('d-none'):"";
   });
	$('#dropdownMenuSearchButton').on('click', function (event) {
  ...
  @endif
  @yield('script')
  <script src="https://kit.fontawesome.com/d41a4fe355.js" crossorigin="anonymous"></script>
</body>
