                ...
                <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                    <div class="slider-header fadeInDown-1"><span
                        style="color:{{ $sliders->subheadingcolor }}!important">{{ $sliders->heading }}</span></div>
                    <div class="big-text fadeInDown-1"> <span
                        style="color:{{ $sliders->headingtextcolor }}!important">{{ $sliders->topheading }}</span> </div>
                    <div class="excerpt fadeInDown-2 hidden-xs"> <span
                        style="color:{{ $sliders->moredesccolor }}!important">{{ $sliders->moredesc }}</span> </div>
                    @if($sliders->buttonname !='')
                    <div class="button-holder fadeInDown-3"> <a
                        style="background: {{ $sliders->btnbgcolor }}!important;color:{{ $sliders->btntextcolor }}!important"
  ...
  <section id="home-product-tab" class="home-product-tab-main-block">
    ...
    <div id="menu1" class="tab-pane fade">
      <div class="top-category-block">
        ...
        <div class="display-none top_cat_header cn_top_cat_header">
          <h3 class="cat_title cn_cat_title">{{ __('staticwords.tpc') }}</h3>
        </div>
        <br>
...
<div class="feature-product-block">
  ...
  <div class="top_cat_header cn_top_cat_header">
    <h3 class="cat_title cn_cat_title">{{ __('staticwords.tpc') }}</h3>
  </div>
  <br>
