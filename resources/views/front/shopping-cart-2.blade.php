     ...
     <div class="col-md-8">
      ...
      @endif
        ...
        <div class="shopping-cart shopping-cart-top">
          <h2 class="heading-title"><?php echo $count.($count==1?"Product":"Products"); ?> <span>{{ __('staticwords.inyourcart') }}</span></h2>
              ...
              <div class="col-md-4 col-xs-9">
                ...
                <div class="romove-item cart-price ">
                  ...
                  @if(Auth::user()->wishlist->count()<1)
                    ...
                    <li><a id="addtowish{{ $row->variant_id }}" onclick="addtowishlist('{{ $row->variant_id  }}')" title="Add to wishlist" class="cursor-pointer icon addtowish"><i class="icon fa fa-heart"></i></a></li>
                  ...
                  @endif
                   ...
                   <li><a href="{{url('remove_table_cart/'.$row->variant_id)}}" title="Remove from cart" class="icon"><i class="fas fa-trash"></i></a></li>
...
<!-- ======================== ================== ============================= -->
            ...
            <div class="row product">
              ...
              <div class="col-md-4 col-xs-9">
                ...
                <div class="romove-item cart-price text-right">
                  <ul>
                    <li><a href="{{url('remove_cart/'.$row['variantid'])}}" title="Remove this item from cart?" class="icon"><i class="fas fa-trash"></i></a>
                    </li>
       ...
       <div class="col-md-4 nogrid-left"  data-sticky data-sticky-for="992" data-margin-top="20"> 
        <div class="shopping-cart shopping-cart-widget">
