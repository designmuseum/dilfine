...
/** Top categories and Featured Products */
    Route::get('/topcategory/products', 'Api\MainController@topcategoryProducts');
    Route::get('/featured/products', 'Api\MainController@featuredProducts');
    Route::get('/mainwidget/products', 'Api\MainController@mainWidget');
/** End */
...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::post('wishlist/remove/{variantid}', 'Api\ProductController@removeitemfromWishlist');
});
