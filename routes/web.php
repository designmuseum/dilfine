...
Route::view('lazyload', 'lazyload');

Route::get('/track','TestController@test');
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group(['middleware' => ['maintainence_mode']], function () {
        ...
        Route::group(['middleware' => ['IsInstalled', 'isActive', 'switch_lang']], function () {

            Route::get('/', 'MainController@index'); // Site Home Page
        ...
        Route::get('/package', 'GuestController@package');
        Route::get('/awb/{id}', 'GuestController@awb');
        ...
        Route::group(['middleware' => ['auth']], function () {
            ...
            Route::get('mytickets', 'HelpDeskController@userticket')->name('user_t');
    ...
    Route::group(['middleware' => ['isActive', 'IsInstalled', 'switch_lang', 'auth', 'is_admin']], function () {
		...
		Route::post('admin/return_policy', 'ReturnProductController@store');
